...
class LessName {
  ...
  static const Map<String,dynamic> aytmat = {'ad':'AYT Matematik','kod':'ayt/aytmat','icon':DanIcons.matIcon,'renk':DanColor.matRenk,'lottie':'assets/lottie/mat.json'};
  static const Map<String,dynamic> aytfiz = {'ad':'AYT Fizik','kod':'ayt/Say/aytfiz','icon':DanIcons.fizikIcon,'renk':DanColor.fizikRenk,'lottie':'assets/lottie/fizik.json'};
  static const Map<String,dynamic> aytkim = {'ad':'AYT Kimya','kod':'ayt/Say/aytkim','icon':DanIcons.kimIcon,'renk':DanColor.kimRenk,'lottie':'assets/lottie/kimya.json'};
  static const Map<String,dynamic> aytbio = {'ad':'AYT Biyoloji','kod':'ayt/Say/aytbio','icon':DanIcons.bioIcon,'renk':DanColor.bioRenk,'lottie':'assets/lottie/bio.json'};
 
  static const List sayDersler=[aytmat,aytfiz,aytkim,aytbio];

  static const Map<String,dynamic> aytedeb = {'ad':'AYT Edebiyat','kod':'ayt/aytedeb','icon':DanIcons.turkceIcon,'renk':DanColor.edebRenk,'lottie':'assets/lottie/turkce.json'};
  static const Map<String,dynamic> aytcog1 = {'ad':'AYT Coğrafya-1','kod':'ayt/aytcog1','icon':DanIcons.cogIcon,'renk':DanColor.cogRenk,'lottie':'assets/lottie/cog.json'};
  static const Map<String,dynamic> ayttar1 = {'ad':'AYT Tarih-1','kod':'ayt/ayttar1','icon':DanIcons.tarihIcon,'renk':DanColor.tarihRenk,'lottie':'assets/lottie/history.json'};

  static const List eaDersler=[aytmat,aytedeb,aytcog1,ayttar1];


  static const Map<String,dynamic> ayttar2 = {'ad':'AYT Tarih-2','kod':'ayt/soz/ayttar2','icon':DanIcons.tarihIcon,'renk':DanColor.tarihRenk,'lottie':'assets/lottie/history.json'};
  static const Map<String,dynamic> aytcog2= {'ad':'AYT Coğrafya-2','kod':'ayt/soz/aytcog2','icon':DanIcons.cogIcon,'renk':DanColor.cogRenk,'lottie':'assets/lottie/cog.json'};
  static const Map<String,dynamic> aytfel = {'ad':'AYT Fel. ve Din','kod':'ayt/soz/aytfel','icon':DanIcons.felseDinIcon,'renk':DanColor.felseDinRenk,'lottie':'assets/lottie/feldin.json'};
